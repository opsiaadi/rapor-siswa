@extends('layouts.guru', [
    ...
    'pageTitle' => 'Kelola Nilai Siswa',
    'breadcrumb' => 'Kelola nilai harian, UTS, UAS',
    'id' => $id ?? 1,
...
<div class="bg-gray-50 p-4 rounded-xl overflow-hidden">
    <h3 class="text-sm font-semibold text-gray-700 mb-4">Kelola Nilai - Kelas {{ $kelasId ?? '' }} (Semester {{ $semester ?? '1' }})</h3>
