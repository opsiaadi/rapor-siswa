    ...
    <form id="nilaiForm" action="{{ route('guru.nilai') }}" method="POST">
        ...
        <div class="flex justify-between mt-6 pt-4 border-t border-gray-200">
            <div class="flex gap-3">
                <button type="button" onclick="editNilai()" class="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-lg font-medium transition-all">
                    Edit
                </button>
            ...
            <button type="button" onclick="kirimNilai()" class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-lg font-medium transition-all shadow-lg shadow-emerald-500/30">
                Kirim
            </button>
        </div>
        @endif
