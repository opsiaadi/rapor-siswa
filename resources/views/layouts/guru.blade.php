...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen font-sans transition-colors duration-300">
    <!-- Mobile Header -->
    <header class="lg:hidden bg-blue-700 dark:bg-blue-900 text-white px-4 py-3 flex items-center justify-between sticky top-0 z-60 shadow-lg">
    ...
    <div class="flex">
        ...
        <header class="hidden lg:flex bg-gradient-to-r from-blue-700 to-indigo-800 dark:from-blue-900 dark:to-indigo-950 text-white border-b border-blue-600 dark:border-blue-800 px-6 py-4 items-center justify-between sticky top-0 z-30 shadow-lg">
            ...
            <div class="flex items-center gap-4">
                <!-- Theme Toggle -->
                <button onclick="toggleTheme()" class="p-2 rounded-lg text-blue-100 hover:text-white hover:bg-white/10 transition-colors relative" title="Toggle Dark/Light Mode">
                    <!-- Sun icon (light mode) -->
                    <svg class="w-5 h-5 block dark:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
