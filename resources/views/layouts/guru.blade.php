...
<body class="bg-gray-50 min-h-screen font-sans transition-colors duration-300">
    <header class="lg:hidden bg-gradient-to-r from-blue-700 to-indigo-800 text-white px-4 py-3 flex items-center gap-3 sticky top-0 z-50 shadow-lg">
                    ...
                    <div class="relative" id="profile-dropdown">
                        ...
                        <div id="profile-panel" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
                            ...
                            <div class="border-t border-gray-100 py-2">
                                <a href="{{ route('guru.profile.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
