...
<body class="bg-gray-50 min-h-screen font-sans transition-colors duration-300">
    <header class="lg:hidden bg-blue-700 text-white px-4 py-3 flex items-center gap-3 sticky top-0 z-50 shadow-lg">
        ...
        <h1 class="text-lg font-bold">{{ $pageTitle ?? 'Dashboard Guru' }}</h1>
    </header>
    ...
    <div class="flex">
        ...
        <div class="flex-1 lg:ml-64 flex flex-col min-h-screen">
            <header class="hidden lg:flex bg-gradient-to-r from-blue-700 to-indigo-800 text-white border-b border-blue-600 px-6 py-4 items-center justify-between sticky top-0 z-30 shadow-lg">
                <div>
                ...
                <div class="flex items-center gap-4">
                    <div class="relative" id="notif-dropdown">
                        <button type="button" onclick="toggleNotifDropdown()" class="p-2 rounded-lg text-blue-100 hover:text-white hover:bg-white/10 transition-colors relative">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5.365V3m0 2.365a5.338 5.338 0 0 1 5.133 5.368v1.8c0 2.386 1.867 2.982 1.867 4.175 0 .593 0 1.292-.538 1.292H5.538C5 18 5 17.301 5 16.708c0-1.193 1.867-1.789 1.867-4.175v-1.8A5.338 5.338 0 0 1 12 5.365ZM8.733 18c.094.852.306 1.54.944 2.112a3.48 3.48 0 0 0 4.646 0c.638-.572 1.236-1.26 1.33-2.112h-6.92Z"/>
                            </svg>
                            <span id="notif-badge" class="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 flex items-center justify-center text-[10px] font-bold text-white bg-red-500 rounded-full hidden">0</span>
                        </button>
    ...
    <script>
    window.__notif = {
        url: '{{ route("guru.notifications") }}',
        readUrl: '{{ url("guru/notifications") }}',
        csrf: '{{ csrf_token() }}',
