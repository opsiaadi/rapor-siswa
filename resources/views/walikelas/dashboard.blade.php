...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm  ">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900 ">{{ $stats['kelas_perwalian'] ?? 0 }}</p>
                </div>
        ...
        <div class="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm  ">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 ">Mapel Diampu</p>
                    <p class="mt-2 text-3xl font-bold text-gray-900 ">{{ $stats['mapel_diampu'] ?? 0 }}</p>
                </div>
                <div class="rounded-2xl bg-emerald-100 p-3 text-emerald-700  ">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
