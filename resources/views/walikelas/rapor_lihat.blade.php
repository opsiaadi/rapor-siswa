...
<div class="space-y-6">
    ...
    <div class="flex justify-center">
        <a href="{{ route('walikelas.cetak.rapor', ['siswaId' => $siswa->id, 'semester' => $semester]) }}" class="inline-flex items-center gap-2 rounded-full bg-emerald-600 hover:bg-emerald-700 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:scale-105">
