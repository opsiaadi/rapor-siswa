                ...
                <tbody class="divide-y divide-gray-100 ">
                    ...
                    <tr class="hover:bg-gray-50  transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 text-right">
                            @php $isSudah = ($siswa->status_rapor?->value ?? '') == 'sudah'; @endphp
        ...
        <div class="block md:hidden space-y-3 px-6 py-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-4">
                <div class="flex items-center justify-between mb-3">
                    ...
                    @else
                    <span class="inline-flex items-center gap-1 rounded-full bg-amber-50 px-2 py-0.5 text-xs font-semibold text-amber-700 border border-amber-100 shrink-0">
                        <svg class="h-3 w-3" fill="currentColor" viewBox="0 0 20 20"><circle cx="10" cy="10" r="8"/></svg>
                        Belum
                    </span>
                    @endif
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('walikelas.rapor-lihat', ['siswaId' => $siswa->id]) }}" class="flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 px-3 py-2 text-xs font-semibold text-white transition-all duration-200">
            ...
            <div class="text-center py-10">
                <div class="rounded-2xl border border-dashed border-gray-300 px-4 py-6 mx-4">
                    <p class="text-sm text-gray-500">Data siswa untuk kelas perwalian belum tersedia.</p>
                </div>
            </div>
            @endforelse
        </div>
