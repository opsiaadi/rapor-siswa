                    ...
                    <tr class="hover:bg-gray-50  transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('walikelas.rapor', ['siswaId' => $siswa->id]) }}"
                                class="inline-flex items-center gap-1.5 rounded-lg bg-maust-400 hover:bg-blue-700 active:scale-95 px-3 py-1.5 text-xs font-semibold text-white shadow-sm shadow-blue-500/30 transition-all duration-150"
