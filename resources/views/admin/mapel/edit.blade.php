...
<div class="space-y-6">
    ...
    <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 ">Edit Mata Pelajaran</h2>
                <p class="text-sm text-gray-500  mt-1">Ubah data mata pelajaran</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nama_mapel" id="nama_mapel" value="{{ old('nama_mapel', $mapel->nama_mapel ?? '') }}" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-gray-900 bg-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-sm" placeholder="Contoh: Matematika" required>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50  border-t border-gray-100  flex items-center justify-end gap-3">
                <a href="{{ route('admin.mapel.index') }}" class="px-4 py-2.5 text-sm font-medium text-gray-700  bg-white  border border-gray-300  rounded-lg hover:bg-gray-50  transition-colors">
                    Batal
                </a>
                <button type="submit" class="px-4 py-2.5 text-sm font-medium text-white bg-amber-600 hover:bg-amber-700 rounded-lg focus:ring-4 focus:ring-amber-300  transition-colors flex items-center gap-2">
