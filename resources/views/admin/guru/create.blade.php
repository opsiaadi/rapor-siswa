    ...
    <form action="{{ route('admin.guru.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50  border-t border-gray-100  flex items-center justify-end gap-3">
                <a href="{{ route('admin.guru.index') }}" class="px-4 py-2.5 text-sm font-medium text-gray-700  bg-white  border border-gray-300  rounded-lg hover:bg-gray-50  transition-all duration-200 hover:scale-105 active:scale-95">
                    Batal
                </a>
