...
<div class="space-y-6">
    ...
    <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 ">Tambah Siswa Baru</h2>
                <p class="text-sm text-gray-500  mt-1">Lengkapi data siswa baru</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-100  bg-gradient-to-r from-blue-50 to-indigo-50  ">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-blue-200 flex items-center justify-center text-blue-300">
