...
<div class="space-y-6">
    ...
    <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Tambah Guru Baru</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lengkapi data guru mata pelajaran</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-t border-gray-100 dark:border-gray-700 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    @empty
                    <p class="text-sm text-gray-500 dark:text-gray-400 col-span-2">Belum ada data mata pelajaran. <a href="{{ route('admin.mapel.create') }}" class="text-indigo-600 hover:underline">Tambahkan mapel terlebih dahulu</a>.</p>
                    @endforelse
                </div>
                @error('mapel_ids')
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-3">
                <a href="{{ route('admin.guru.index') }}" class="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                    Batal
                </a>
                <button type="submit" class="px-4 py-2.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg focus:ring-4 focus:ring-indigo-300 dark:focus:ring-indigo-800 transition-colors flex items-center gap-2">
