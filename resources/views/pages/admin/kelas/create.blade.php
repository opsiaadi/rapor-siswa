...
<div class="space-y-6">
    ...
    <div class="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Tambah Kelas Baru</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Buat kelas dan tentukan mapel + wali kelas</p>
            </div>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.kelas.store') }}" method="POST" class="max-w-2xl">
        @csrf
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kelas" id="nama_kelas" value="{{ old('nama_kelas') }}"
                        class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm"
                ...
                <!-- Wali Kelas -->
                <div>
                    <label for="wali_kelas_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Wali Kelas <span class="text-red-500">*</span></label>
            ...
            <div class="p-6 border-t border-gray-100 dark:border-gray-700 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10">
                ...
                <div class="space-y-3">
                    ...
                    @php
                        $guruPengampu = \App\Helpers\FakeDataHelper::findGuruByMapel($mapel->id);
                    @endphp
                    ...
                    @empty
                    <p class="text-sm text-gray-500 dark:text-gray-400">Belum ada data mata pelajaran. <a href="{{ route('admin.mapel.create') }}" class="text-emerald-600 hover:underline">Tambahkan mapel terlebih dahulu</a>.</p>
                    @endforelse
                </div>
            </div>
