    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <a href="/homepage" class="flex items-center space-x-3">
                <img src="{{ asset('images/open-book.png') }}" class="h-8 w-auto" alt="SiRapor">
                <span class="text-xl font-bold text-gray-900 tracking-tight">SiRapor</span>
            </a>

            <div class="hidden md:flex md:items-center md:space-x-8">
                <a href="#hero" class="text-sm font-medium text-emerald-600">Beranda</a>
                <a href="#fitur" class="text-sm font-medium text-gray-600 hover:text-emerald-600 transition-colors">Fitur</a>
                <a href="#tentang" class="text-sm font-medium text-gray-600 hover:text-emerald-600 transition-colors">Tentang</a>
                <a href="#kontak" class="text-sm font-medium text-gray-600 hover:text-emerald-600 transition-colors">Kontak</a>
            </div>

            <div class="hidden md:flex items-center space-x-3">
                <a href="{{ route('login') }}" class="text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg px-5 py-2 hover:bg-gray-50 transition-colors">Masuk</a>
            </div>
...
<!-- ==================== HERO ==================== -->
<section id="hero" class="relative pt-16 overflow-hidden bg-gradient-to-br from-emerald-700 via-emerald-600 to-teal-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-center lg:text-left">
                <span class="inline-block px-4 py-1.5 bg-white/10 text-white text-xs font-semibold rounded-lg mb-6 border border-white/20">Platform Manajemen Rapor Digital</span>
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight">
                    Kelola Rapor Siswa
                    <span class="text-emerald-200">Lebih Mudah</span>
                </h1>
                <p class="mt-5 text-lg text-white/90 font-medium max-w-xl mx-auto lg:mx-0 leading-relaxed">
                ...
                <div class="mt-8 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold px-8 py-3.5 rounded-lg hover:bg-emerald-50 transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5">
                        Mulai Sekarang
                        <span class="material-symbols-outlined text-lg">arrow_forward</span>
                    </a>
                    <a href="#fitur" class="inline-flex items-center gap-2 text-white border border-white/30 px-8 py-3.5 rounded-lg hover:bg-white/10 transition-colors">
                        Lihat Fitur
                ...
                <div class="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-6">
                    <div class="text-center">
                        ...
                        <div class="text-emerald-200 text-sm mt-1">Siswa</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-extrabold text-white">450+</div>
                        <div class="text-emerald-200 text-sm mt-1">Guru</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-extrabold text-white">14</div>
                        <div class="text-emerald-200 text-sm mt-1">Mata Pelajaran</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-extrabold text-white">10+</div>
                        <div class="text-emerald-200 text-sm mt-1">Sekolah</div>
                    </div>
                </div>
            </div>

            <div class="hidden lg:flex justify-center">
                <img src="{{ asset('images/homepage.png') }}" alt="SiRapor Illustration" class="w-full max-w-lg rounded-lg shadow-2xl shadow-emerald-900/30">
            </div>
        </div>
    </div>
</section>
...
<section id="fitur" class="py-20 lg:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14">
            <span class="inline-block px-4 py-1.5 bg-emerald-50 text-emerald-700 text-xs font-semibold rounded-lg mb-4">FITUR</span>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Semua Kebutuhan Akademik dalam Satu Platform</h2>
            <p class="mt-4 text-gray-500 leading-relaxed">Fitur lengkap yang memudahkan guru, wali kelas, dan admin dalam mengelola data akademik sekolah.</p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                </div>
            ...
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14l4-4h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/></svg>
                </div>
            ...
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 0h14V7H7v2zm0 4h14v-2H7v2zm0 4h14v-2H7v2z"/></svg>
                </div>
            ...
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M19 8H5c-1.1 0-2-.9-2-2s.9-2 2-2h14c1.1 0 2 .9 2 2s-.9 2-2 2zm0 2H5c-1.1 0-2 .9-2 2s.9 2 2 2h14c1.1 0 2-.9 2-2s-.9-2-2-2zm0 4H5c-1.1 0-2 .9-2 2s.9 2 2 2h14c1.1 0 2-.9 2-2s-.9-2-2-2z"/></svg>
                </div>
            ...
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                </div>
            ...
            <div class="group p-6 bg-white border border-gray-200 rounded-xl hover:shadow-xl hover:border-emerald-200 transition-all duration-300 hover:-translate-y-1">
                <div class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                    <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg>
                </div>
...
<!-- ==================== TENTANG ==================== -->
<section id="tentang" class="py-20 lg:py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14">
            <span class="inline-block px-4 py-1.5 bg-emerald-50 text-emerald-700 text-xs font-semibold rounded-lg mb-4">TENTANG</span>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Kenapa SiRapor?</h2>
            <p class="mt-4 text-gray-500 leading-relaxed">Platform manajemen rapor sekolah digital yang dirancang untuk mempermudah proses pengelolaan nilai dan laporan akademik.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-16">
            <div class="bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="w-14 h-14 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5">
                    <svg class="w-7 h-7 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 2c-.791 0-1.55.314-2.11.874l-.893.893a.985.985 0 0 1-.696.288H7.04A2.984 2.984 0 0 0 4.055 7.04v1.262a.986.986 0 0 1-.288.696l-.893.893a2.984 2.984 0 0 0 0 4.22l.893.893a.985.985 0 0 1 .288.696v1.262a2.984 2.984 0 0 0 2.984 2.984h1.262c.261 0 .512.104.696.288l.893.893a2.984 2.984 0 0 0 4.22 0l.893-.893a.985.985 0 0 1 .696-.288h1.262a2.984 2.984 0 0 0 2.984-2.984V15.7c0-.261.104-.512.288-.696l.893-.893a2.984 2.984 0 0 0 0-4.22l-.893-.893a.985.985 0 0 1-.288-.696V7.04a2.984 2.984 0 0 0-2.984-2.984h-1.262a.985.985 0 0 1-.696-.288l-.893-.893A2.984 2.984 0 0 0 12 2Zm3.683 7.73a1 1 0 1 0-1.414-1.413l-4.253 4.253-1.277-1.277a1 1 0 0 0-1.415 1.414l1.985 1.984a1 1 0 0 0 1.414 0l4.96-4.96Z" clip-rule="evenodd"/></svg>
                </div>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="text-center p-8 bg-white rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-5">
                    <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4.5V19a1 1 0 0 0 1 1h15M7 14l4-4 4 4 5-5m0 0h-3.207M20 9v3.207"/></svg>
                </div>
            ...
            <div class="text-center p-8 bg-white rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-5">
                    <svg class="w-8 h-8 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M10 5a2 2 0 0 0-2 2v3h2.4A7.48 7.48 0 0 0 8 15.5a7.48 7.48 0 0 0 2.4 5.5H5a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h1V7a4 4 0 1 1 8 0v1.15a7.446 7.446 0 0 0-1.943.685A.999.999 0 0 1 12 8.5V7a2 2 0 0 0-2-2Z" clip-rule="evenodd"/><path fill-rule="evenodd" d="M10 15.5a5.5 5.5 0 1 1 11 0 5.5 5.5 0 0 1-11 0Zm6.5-1.5a1 1 0 1 0-2 0v1.5a1 1 0 0 0 .293.707l1 1a1 1 0 0 0 1.414-1.414l-.707-.707V14Z" clip-rule="evenodd"/></svg>
                </div>
            ...
            <div class="text-center p-8 bg-white rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-5">
                    <svg class="w-8 h-8 text-emerald-600" fill="currentColor" viewBox="0 0 24 24"><path d="M5 3a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm14 18a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4ZM5 11a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H5Zm14 2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4Z"/></svg>
                </div>
...
<!-- ==================== CTA ==================== -->
<section class="py-16 bg-gradient-to-r from-emerald-700 to-emerald-600">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h2 class="text-3xl sm:text-4xl font-extrabold text-white mb-4 tracking-tight">Siap Mempermudah Pengelolaan Rapor?</h2>
        <p class="text-emerald-100 mb-8 max-w-xl mx-auto leading-relaxed">Mulai gunakan SiRapor sekarang dan rasakan kemudahan dalam mengelola nilai dan rapor siswa.</p>
        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold px-8 py-3.5 rounded-lg hover:bg-emerald-50 transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5">
            Mulai Sekarang
        ...
        <div class="grid md:grid-cols-4 gap-8">
            <div class="md:col-span-2">
                <div class="flex items-center space-x-3 mb-4">
                    <img src="{{ asset('images/open-book.png') }}" class="h-7 w-auto brightness-0 invert" alt="SiRapor">
                    <span class="text-lg font-bold text-white tracking-tight">SiRapor</span>
                </div>
